...
resumen: "La compra de GitHub por Microsoft parecía arriesgada en 2018, pero encajaba con la nueva estrategia de Satya Nadella: acercarse a desarrolladores y al open source."
source: AJRA-v09/_posts/2018-06-04-microsoft-compra-github.md
---
...
También acabó llegando a dispositivos móviles, como comenté más adelante con [GitHub para iOS y iPadOS](/blog/github-ios/).

La operación no era solo comprar una empresa. Era comprar relación, confianza e infraestructura.

Si quieres explicar software, open source o estrategia tecnológica de forma clara para usuarios no técnicos o equipos de negocio, puedes [escribirme a ajra@ajra.es](mailto:ajra@ajra.es).
