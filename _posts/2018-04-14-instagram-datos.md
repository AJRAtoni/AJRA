...
El caso de [Cambridge Analytica y Facebook](/blog/facebook-filtrados/) aceleró una conversación que ya venía creciendo: qué datos recogen las plataformas, para qué los usan y qué control real tiene el usuario.
...
Si quieres revisar cómo recoges, explicas y proteges los datos de tus clientes o usuarios, puedes [escribirme a ajra@ajra.es](mailto:ajra@ajra.es).
