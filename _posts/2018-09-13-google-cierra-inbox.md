...
resumen: "Inbox fue una app querida porque probó ideas útiles para gestionar el correo, pero Google decidió cerrar el experimento y llevar parte de sus funciones a Gmail."
source: AJRA-v09/_posts/2018-09-13-google-cierra-inbox.md
---
...
Otros clientes también estaban empujando en esa dirección, como [Spark](/blog/spark-actualiza/) con envío programado, seguimiento de correos y más tarde colaboración en [Spark 2.0](/blog/spark-2/).
...
Si quieres revisar tu sistema de correo, productividad o dependencia de herramientas concretas antes de que un cierre te afecte, puedes [escribirme a ajra@ajra.es](mailto:ajra@ajra.es).
